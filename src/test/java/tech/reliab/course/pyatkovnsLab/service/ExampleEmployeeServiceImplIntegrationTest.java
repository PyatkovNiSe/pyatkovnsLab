...
class ExampleEmployeeServiceImplIntegrationTest {
    ...
    void testCreateEmployee() {
        ...
        Employee createdEmployee = employeeServiceImpl.createEmployee(request);
    ...
    void testUpdateEmployee() {
        ...
        Employee createdEmployee = employeeServiceImpl.createEmployee(request);
        Employee updatedEmployee = employeeServiceImpl.updateEmployee(createdEmployee.getId(), "Jane Johnson");
    ...
    void testGetEmployeeById() {
        ...
        Employee createdEmployee = employeeServiceImpl.createEmployee(request);
        Employee foundEmployee = employeeServiceImpl.getEmployeeDtoById(createdEmployee.getId());
    ...
    void testGetAllEmployees() {
        ...
        employeeServiceImpl.createEmployee(request1);
        ...
        employeeServiceImpl.createEmployee(request2);
    ...
    void testDeleteEmployee() {
        ...
        employeeServiceImpl.deleteEmployee(createdEmployee.getId());

        Assertions.assertThrows(
                RuntimeException.class,
                () -> employeeServiceImpl.getEmployeeDtoById(createdEmployee.getId()),
